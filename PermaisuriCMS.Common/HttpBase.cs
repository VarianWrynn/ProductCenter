...
namespace PermaisuriCMS.Common
{
    ...
    public class HttpBase
    {
        ...
        /// 
        /// </summary>
        public NameValueCollection KeyValuedData
        {
            get { return _keyValuedData; }
            set { _keyValuedData = value; }
        }*/
        ...
        /*/// <summary>
        /// 从response header中获取转向url，同时传回cookie
        /// </summary>
        ...
        public virtual string GetRedirectURL(HttpWebResponse webresponse, ref string Cookie)
        {
            ...
            if ((webresponse.StatusCode == HttpStatusCode.Found) || (webresponse.StatusCode == HttpStatusCode.Redirect) ||
              (webresponse.StatusCode == HttpStatusCode.Moved) || (webresponse.StatusCode == HttpStatusCode.MovedPermanently))
            {
                // 获取转向Uri
        ...
        public virtual byte[] GetResponse(string url, string method, string requestBody)
        {
            ...
            try
            {
                ...
                /*
tgc=TGT-MTExNDMwODg3Nw==-1294129295-87B74BCB1356E809B9CECFCF0B60E297; domain=log
in.sina.com.cn; path=/; Httponly,SUE=es%3D7b3b8f224d50fb38921505abe2abeda1%26ev%
3Dv0%26es2%3D4594a9d34f9559a342adc327c33a7bc2;path=/;domain=.sina.com.cn;Httponl
y,SUP=cv%3D1%26bt%3D1294129296%26et%3D1294215696%26lt%3D1%26uid%3D1114308877%26u
ser%3Dnamefree%26ag%3D2%26name%3Dnamefree.student%2540sina.com%26nick%3Dnamefree
%26sex%3D1%26ps%3D0%26email%3Dnamefree.student%2540sina.com%26dob%3D1983-06-07%2
6ln%3Dnamefree;path=/;domain=.sina.com.cn,ALC=cv%3D1.0%26es%3D0ffc0a5534d8f34095
bf3ec28b20a2c0%26bt%3D1294129296%26et%3D1294734096%26uid%3D1114308877;expires=Tu
esday, 11-Jan-11 08:21:36 GMT;path=/;domain=login.sina.com.cn;Httponly,ALF=12947
34096;expires=Tuesday, 11-Jan-11 08:21:36 GMT;path=/;domain=.sina.com.cn,SUR=uid
%3D1114308877%26user%3Dnamefree%26nick%3Dnamefree%26email%3Dnamefree.student%254
0sina.com%26dob%3D1983-06-07%26ag%3D2%26sex%3D1%26ssl%3D0;expires=Tuesday, 11-Ja
n-11 08:21:36 GMT;path=/;domain=.sina.com.cn 
                 */
                ...
                //        _responseCookies.Add(c.Name, c.Value);
                //    }
                //}
                #endregion
            }
