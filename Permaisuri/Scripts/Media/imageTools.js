...
define(function (require, exports, module) {
    ...
    var imgAreaSelect =  require('./jquery.imgareaselect.pack');
    exports.ImagesUtil = {
        ratio: 1,
        view_H: 300,
        view_W: 300,
        initialize: function (path) {
            ...
            $("#user_head_100").attr("src", path);
            $("#user_head_160").attr("src", path);
            var img = new Image();
            img.src = path;
            if (img.width == 0) {
                var obj = this;
            ...
            if (img) {
                ...
                $('img#user_head_origin').imgAreaSelect({
                    ...
                    onSelectChange: function (img, selection) {
                        ...
                        obj.preview('user_head_100', obj.view_W, obj.view_H, selection.x1, selection.y1, selection.width, selection.height, 100, 100);
                        obj.preview('user_head_160', obj.view_W, obj.view_H, selection.x1, selection.y1, selection.width, selection.height, 160, 160);
                ...
                this.preview('user_head_100', this.view_W, this.view_H, x, y, size, size, 100, 100);
                this.preview('user_head_160', this.view_W, this.view_H, x, y, size, size, 160, 160);
    ...
    exports.cancelImage = function() {
       ...
       /* var path = $("img#origin_user_head_75").attr("src");
        ...
        if (index != -1) {
            ...
            $("#user_head_75").attr("src", "/headphone/100/" + name).css({
                width: 75 + 'px',
                height: 75 + 'px',
                marginLeft: 0,
                marginTop: 0
        ...
        $("#user_head_100").attr("src", "");
        $("#user_head_160").attr("src", "");
    }
});