...
define(function (require, exports, module) {
    ...
    exports.RenderReport = {
        ...
        Render: function (data, callBack) {
            ...
            sHtml += '<th width="25%" class="dataTableHeader" align="left" orderBy="1">Part <span></span></th>';
            sHtml += '<th width="15%" class="dataTableHeader" align="center" orderBy="2">Invetory<span></span></th>';
            sHtml += '<th width="35%" class="dataTableHeader" align="center" orderBy="3">Expected Inventory <span></span> </th>';
            sHtml += '<th width="25%" class="dataTableHeader" align="center" orderBy="4">Next Shipment<span></span></th>';
            sHtml += '<th width="" class="dataTableHeader" align="center" orderBy="5">Affected SKUs<span></span></th></tr> </thead>';
            sHtml += '<tbody>';
            $.each(data["List"], function () {
                ...
                sHtml += '<td valign="center"><span>' + this.Part + '</span></td>';
                ...
                sHtml += '<td valign="center" align="center" ><div class="reportAffectedSKU">' + this.AffectedSKUS + '</div></td>';
                //sHtml += '<td valign="center" align="center" >' + this.AffectedSKUS + '</td>';
                sHtml += '</tr>';
            })
            sHtml += '</tbody></table>';
            ...
            $(".salesblok table thead th:eq(5)").css("cursor", "").off("click");//AffectedSKUS无法排序，禁止掉
