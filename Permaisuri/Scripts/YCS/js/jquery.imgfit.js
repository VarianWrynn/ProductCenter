...
(function(){
    ...
    if(!$.imgfitClass){
        $.imgfitClass = function($img,option){
            ...
            this.config             = { align : "c", fit : "all", canvasMode : false, position:'absolute', minWidth:undefined, minHeight:undefined, maxWidth:undefined, maxHeight:undefined, callBack : undefined, autoResize : true };
            ...
            this.fit = function(){
                ...
                switch(this.config.align){
                    ...
                    case 'lb'       :   this.css.left = 0; this.css.top = (frameH-this.css.height);
                                        break;
                    case 'lc'       :   this.css.left = 0; this.css.top = (frameH-this.css.height)*0.5;
                                        break;
                    ...
                    case 'rb'       :   this.css.left = (frameW-this.css.width); this.css.top = (frameH-this.css.height);
                                        break;
                    case 'rc'       :   this.css.left = (frameW-this.css.width); this.css.top = (frameH-this.css.height)*0.5;
                                        break;
                    case 'c_l640'   :   this.css.left = (frameW-this.css.width)*0.5 + 640; this.css.top = (frameH-this.css.height)*0.5;
                                        break;
                    case 'c_r640'   :   this.css.left = (frameW-this.css.width)*0.5 - 640; this.css.top = (frameH-this.css.height)*0.5;
                                        break;
                }
